...
import { LordOfMysteriesActionsSheet } from "./actions-sheet.mjs";
...
export class LordOfMysteriesActorSheet extends ActorSheet {
  ...
  activateListeners(html) {
    ...
    // 행동 시트 토글
    html.find('.open-actions').click(this._onOpenActions.bind(this));
   ...
   * 행동 시트 열기
   */
  _onOpenActions(event) {
    event.preventDefault();
    
    // 새 창으로 행동 시트 렌더링
    new LordOfMysteriesActionsSheet(this.actor, {
      title: `${this.actor.name} - 행동 시트`
    }).render(true);
  }
